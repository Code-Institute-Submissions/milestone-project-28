...
- 1. an "a" element cannot be nested within a "button" elements and vice versa : "The element button must not appear as a descendant of the a element" AND "The element a must not appear as a descendant of the button element."
